...
**DevOps / Site Reliability Engineer** focused on infrastructure as code, containers, CI/CD, and deploying open-source platforms at scale.

## About me

- DevOps Engineer at [Wazuh](https://github.com/wazuh), the open-source security platform (SIEM/XDR) used by thousands of organizations.
- I maintain Wazuh's public deployment repositories: Docker, Kubernetes, Puppet, Ansible, virtual machines, and assisted installation.
- 15+ years in IT: from Oracle/SQL Server database administration and data warehousing on Exadata to DevOps/SRE.
- 5+ years focused on DevOps, CI/CD pipelines, and cloud platforms (AWS, Azure/Entra ID, Oracle Cloud).
...
![PL/SQL](https://img.shields.io/badge/PL_SQL-F80000?style=flat&logo=oracle&logoColor=white)

### Security & Monitoring

![Wazuh](https://img.shields.io/badge/Wazuh-SIEM_XDR-1B8BF0?style=flat)
...
![Agile](https://img.shields.io/badge/Agile_Scrum-0A9DC7?style=flat)
...
Public deployment repositories I maintain as part of my role as DevOps Engineer at Wazuh:

- **[wazuh/wazuh-docker](https://github.com/wazuh/wazuh-docker)** — Maintainer. Docker containers for deploying the Wazuh platform.
- **[wazuh/wazuh-kubernetes](https://github.com/wazuh/wazuh-kubernetes)** — Maintainer. Wazuh deployment on Kubernetes.
- **[wazuh/wazuh-puppet](https://github.com/wazuh/wazuh-puppet)** — Maintainer. Wazuh deployment with Puppet.
- **[wazuh/wazuh-ansible](https://github.com/wazuh/wazuh-ansible)** — Maintainer. Wazuh deployment with Ansible.
- **[wazuh/wazuh-installation-assistant](https://github.com/wazuh/wazuh-installation-assistant)** — Maintainer.
- **[wazuh/wazuh-virtual-machines](https://github.com/wazuh/wazuh-virtual-machines)** — Maintainer.
